...
extern void *mono_aot_module_ShopsAggregator_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_ShopsAggregator_info;
...
extern void *mono_aot_module_ShopsAggregatorLib_info;
extern void *mono_aot_module_MongoDB_Bson_info;
...
{
	mono_aot_register_module (mono_aot_module_ShopsAggregator_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_ShopsAggregator_info);
	...
	mono_aot_register_module (mono_aot_module_ShopsAggregatorLib_info);
	mono_aot_register_module (mono_aot_module_MongoDB_Bson_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "ShopsAggregator.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
